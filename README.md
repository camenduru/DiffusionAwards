...
### 🍡 Type of sponsorship
- Media sponsorship: Media sponsors provide announcements for the diffusion award. [Media Sponsorship Application](https://github.com/camenduru/DiffusionAwards/issues/new?assignees=&labels=&template=media_sponsor_application.yml)
- Service or(and) Monetary sponsorship: Service sponsors provide services or(and) monetary awards to the winners. [Sponsorship Application](https://github.com/camenduru/DiffusionAwards/issues/new?assignees=&labels=&template=sponsor_application.yml)
